...
class GameApi {
    /**
     * @param string $SERVER 数据操作接口地址
     * @param string $PORT 数据操作接口端口
     * @param string $ADMIN_PWD 数据操作接口密码
     * @var string
     */
    static $SERVER = '192.168.1.120'; 
    static $PORT   = 8011;
    static $ADMIN_PWD = 'ybybyb';
