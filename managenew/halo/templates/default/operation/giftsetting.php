			...
			<form name="post_gift_submit" id="post_gift_submit" action="<?php echo INDEX; ?>?m=operation&c=giftsetting&v=add" method="post">
				...
				<table class="global" width="100%" cellpadding="0" cellspacing="0" id="gifttag">
					...
					<tr>
						...
						<td>
							<input type="radio" name="gifttype" value="0" id="gifttype0" {if $giftarr[gifttype] != 1}checked{/if}>每服总领取次数
							<input type="radio" name="gifttype" value="1" id="gifttype1" {if $giftarr[gifttype] == 1}checked{/if}>每服每日领取次数
						</td>
