...
//		$sid = array_search($fid,$menu_list);
	...
	public function update(){
		...
		foreach ($modify_id_arr as $modify_id){
			$query = $this->menusub->update(array('column_desc'=>$_GET['column_desc'.$modify_id],'column_type'=>$_GET['column_type'.$modify_id],'column_type_length'=>$_GET['column_type_length'.$modify_id],'default_val'=>$_GET['default_val'.$modify_id],'type_sql'=>$_GET['type_sql'.$modify_id],'type_val'=>$_GET['type_val'.$modify_id],'column_sort'=>$_GET['column_sort'.$modify_id],'column_status'=>$_GET['column_status'.$modify_id],'column_key'=>$_GET['column_key'.$modify_id],'column_search'=>$_GET['column_search'.$modify_id],'is_template'=>$_GET['is_template'.$modify_id],'is_search'=>$_GET['is_search'.$modify_id]),'id='.$modify_id.'');
		}
		if ($query){
