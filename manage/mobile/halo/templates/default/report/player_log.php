...
<?php }else if (in_array($key,array('long_yu_ling','state_point','spirit','xian_ling','xianling_tree','crystal','ling_yun','neidan','marry_favor','ba_xian_ling','marry_gold'))) { ?>
...
function mission_id_to_name(id){
	if (typelist != undefined){
		if (typelist.mission != undefined){
			for (var key in typelist.mission){
				if (typelist.mission[key].id == id){
					return typelist.mission[key].name;
				}
			}
		}
	}
...
function dragonball_id_to_name(id){
	if (typelist != undefined){
		if (typelist.dragonball != undefined){
			for (var key in typelist.dragonball){
				if (typelist.dragonball[key].id == id){
					return typelist.dragonball[key].name;
				}
			}
		}
	}
...
<td>${dragonball_id_to_name(dragonball_id)}</td>
<td>${dragonball_id_to_name(merged_dragonball_id)}</td>
<td>${exp}</td>
