...
<div class="container" id="container">
	...
	<div class="column cf" id="table_column_1" style="display:none">
		...
		<tr>
			...
			<?php if (in_array($value['player_role_id'],$deploy_player)): ?>
			<span class="bluetitle">上阵</span><br>
			<?php else: ?>
				没上阵<br>
			<?php endif ?>
			</p>
			...
			<td>
			<span class="redtitle"><?php echo $value['jue_xing'] ?></span>
			</td>
			<td>
			<span class="redtitle"><?php echo $value['xin_ji'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['health'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['attack'] ?></span>
			<br>
			<span class="greentitle"><?php echo $value['defense'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['hit'] ?></span>
			<br>
			<span class="greentitle"><?php echo $value['dodge'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['critical'] ?></span>
			<br>
			<span class="greentitle"><?php echo $value['kill'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['speed'] ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['first_skill_name'] ? $value['first_skill_name'].' LV'.$value['first_lv'] : '-' ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['second_skill_name'] ? $value['second_skill_name'].' LV'.$value['second_lv'] : '-' ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['third_skill_name'] ? $value['third_skill_name'].' LV'.$value['third_lv'] : '-' ?></span></td>
			<td>
			<span class="redtitle"><?php echo $value['fourth_skill_name'] ? $value['fourth_skill_name'].' LV'.$value['fourth_lv'] : '-' ?></span></td>
		</tr>
		<?php } ?>
		</tbody>
		</table>
