...
Ha.page.colspan = 8;
Ha.page.emptyMsg = '<?php echo Lang('not_player_feedback')?>';
...
$(function(){
	...
	$('#buglist').on('click', 'a.delete', function(){
		...
		if (id > 0){
			if (confirm('<?php echo Lang('confirm_to_del_player_feedback')?>')){
...
<table class="global" style="min-width: 520px" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td>
			<p>
				<input type="submit" value="<?php echo Lang('submit') ?>" id="pop_btnsubmit">
				<input type="hidden" name="id" id="bugid" value="${id}">
				<input type="hidden" name="doSubmit" value="1">
				<input type="button" onclick="dialog.close();" class="cancel_btn" value="<?php echo Lang('close') ?>">
			</p>
			</td>
		</tr>
	</tbody>
...
<div class="container" id="container">
	...
	<div class="column cf" id="table_column">
		<div class="title">
	        <?php echo Lang('player_feedback_data')?>
	    </div>
		<div id="dataTable">
