					...
					$.ajax({
						...
						success: function(data) {
							if (data.status == 0) {
								...
								$('#chk-soul-postsubmit').die('submit');
							}
							alert(data.msgOB);
				...
				if (typeof list != 'undefined' && list.length > 0) {
					for(var key in list) {
						if (list[key].id == id) {
							...
							str = '{"id":'+curitem.id+',"name":"'+name+'","soul_id":'+curitem.soul_id+',"attributeid1":'+curitem.soul_attribute_id_location_1+',"attributevalue1":'+(curitem.soul_attribute_value_location_1*10)+',"attributeid2":'+curitem.soul_attribute_id_location_2+',"attributevalue2":'+(curitem.soul_attribute_value_location_2*10)+',"attributeid3":'+curitem.soul_attribute_id_location_3+',"attributevalue3":'+(curitem.soul_attribute_value_location_3*10)+',"attributeid4":'+curitem.soul_attribute_id_location_4+',"attributevalue4":'+(curitem.soul_attribute_value_location_4*10)+',"key":'+curitem.key+',"number":1}';
							break;
						}
					}
				}
