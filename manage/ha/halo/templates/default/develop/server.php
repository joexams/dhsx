...
$(function(){
	...
	$('#post_submit').on('submit', function(e){
		...
		Ha.common.ajax(url, 'html', objform.serialize(), 'POST', 'container', function(data){
			if (data.status) {
...
<div class="container" id="container">
			...
			<div class="title cf">				
				<div class="more">
	                <ul class="select" id="toolbar">
	                	<li class="active"><a class="order" href="javascript:void(0);" data="0">全部</a></li>
	                	<li><a class="order" href="javascript:void(0);" data="1">待开启<span class="greentitle" id="wait">-</span></a></li>
	                	<li><a class="order" href="javascript:void(0);" data="2">未配置<span class="orangetitle" id="notsetting">-</span></a></li>
	                	<li><a class="order" href="javascript:void(0);" data="3">今日新开<span id="today" class="bluetitle">-</span></a></li>
	                	<li><a class="order" href="javascript:void(0);" data="4">已开启<span id="open" class="redtitle">-</span></a></li>
	                </ul>
	            </div>
				...
				<div class="tool_group">
					 ...
					 <label><?php echo Lang('server_o_name'); ?>：
	...
	<div class="column cf" id="table_column">
		...
		<tr>
			...
			<td>
				<select name="cid" id="cid" class="ipt_select" style="width:100px;"></select>
			</td>
			<td><input type="text" name="name" class="ipt_txt_s" value="qq_s"></td>
			<td><input type="text" name="o_name" class="ipt_txt_s" value="大话神仙s"></td>
			<td>
				<ul>
					<li>
