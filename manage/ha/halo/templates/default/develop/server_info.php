...
<div class="frm_cont" id="submit_area">
    <ul>
        ...
        <li>
			...
			<label><input type="radio" name="test" value="0"<?php echo $data['info']['test'] == 0? ' checked': ''; ?>><?php echo Lang('test'); ?></label>
			<label><input type="radio" name="test" value="1" <?php echo $data['info']['test'] == 1? ' checked': ''; ?>><?php echo Lang('normal'); ?></label> 
