...
<tr>
	<td class="num"><a href="#app=5&cpp=57&url=${encodeurl('report', 'day_total', 'data', '&day=')}${gdate}" class="view" data="${gdate}"><?php echo Lang('view'); ?></a></td>
		...
		<div class="tool_date">
			<div class="title cf">
				...
				<div class="tool_group">
					 ...
					 <input type="text" name="starttime" onclick="WdatePicker()" readonly class="ipt_txt_s">
					 -
					 <input type="text" name="endtime" onclick="WdatePicker()" readonly class="ipt_txt_s"></label>
