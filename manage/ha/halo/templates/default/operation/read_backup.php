...
Ha.page.colspan = 8;
Ha.page.emptyMsg = '尚未有回档申请，若需要申请，点击右侧按钮，申请回档。';
...
function readBackupManage(){
	...
	Ha.common.ajax(url, 'html', '', 'get', 'container', function(data){
		Ha.Dialog.show(data, '添加回档申请', 600, 'readBackupManageDialog');
	}, 1);
}
<?php } ?>
</script>
	...
	<div class="column cf" id="table_column">
		<div class="title">
	        ...
	        <div class="more" id="tblMore">
	            <div id="div_pop">
	                <input class="btn_thin1" type="button" value="角色回档申请">
	            </div>
	        </div>
	        <?php } ?>
	        角色回档列表
		...
		<table>
			<thead>
			    <tr>
					...
					<th><?php echo Lang('恢复时间'); ?></th>
			    	<th><?php echo Lang('申请原因备注'); ?></th>
			    	<th><?php echo Lang('操作人'); ?></th>
			    </tr>
			</thead>
			<tbody id="findlist">
