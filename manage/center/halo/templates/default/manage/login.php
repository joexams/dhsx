...
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    <title><?php echo Lang('da_hua_shen_xian')?>-<?php echo Lang('login')?></title>
  ...
  <body>
	<div class="container">
		<form class="form-signin form-horizontal" id="post_login_submit">
		  <fieldset>
		  <legend><?php echo Lang('please_login')?></legend>
		  <div class="control-group info">
		    <label class="control-label" for="username"><?php echo Lang('account')?></label>
		    <div class="controls">
		      <input type="text" name="username" id="username" placeholder="<?php echo Lang('account')?>">
		    </div>
		  </div>
		  ...
		  <div class="control-group">
		    <div class="controls">
		      ...
		      <button type="submit" class="btn btn-large btn-primary" id="btnsubmit"><?php echo Lang('login')?></button>
		    </div>
		  </div>
		  </fieldset>
		</form>
	...
	var msg = {
		"error_username": "<?php echo Lang('username_length_error')?>",
		"error_password": "<?php echo Lang('password_length_error')?>"
	};
