...
$(function() {
	...
	$('#get_search_submit').on('submit', function(e) {
		...
		if (codeid != '0'){
			...
			Ha.notify.show('<?php echo Lang('please_select_active')?>', '', 'error');
		}
	});
...
<h2>
	<span id="moreBar" class="more"><a id="exportFile" style="" href="javascript:void(0);"><?php echo Lang('export').Lang('coupon'); ?><i class="i_down"></i></a></span>
...
<div class="container" id="container">
			...
			<div class="title cf">	
				<div class="tool_group">
	            	...
	            	<select name="usetype" id="usetype" class="ipt_select" style="width:100px;">
	            		<option value="0"><?php echo Lang('is_used')?></option>
	            		<option value="1"><?php echo Lang('used')?></option>
	            		<option value="2"><?php echo Lang('nouse')?></option>
	            	</select>
				...
				<div class="frm_cont">
					<ul>
						<li name="condition">
							...
							<option value="0"><?php echo Lang('batch')?></option>
							</select> 
						</li>
					</ul>
				</div>
	...
	<div class="column cf" id="table_column">
		<div class="title"><?php echo Lang('detail_data')?></div>
		<div id="dataTable">
		<table>
		<thead>
		<tr id="dataTheadTr">
		...
		<tbody id="couponlist">
			<tr><td colspan="5" style="text-align: left"><?php echo Lang('please_select_activity_to_search')?></td></tr>
		</tbody>
		</table>
		</div>
