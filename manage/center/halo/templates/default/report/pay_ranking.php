...
function showStatData(data)
{
	if (data.count > 0) {
		...
		$('#ARPU').html(data.arpu);
		$('#pay_person_num').html(data.total_pay_person);
	...
	<div class="column cf" id="table_column">
		<div class="speed_result">
	        <div class="mod_tab_cont">
	            <div class="stime">
	                <ul>
	                    <li><?php echo Lang('pay_money'); ?>：<em><strong id="total_amount">0</strong></em></li>
	                    <li><span class="graytitle">ARPU：</span><em><span id="ARPU" class="graytitle">0</span></em></li>
	                    <li><?php echo Lang('pay_person_num'); ?>：<em><strong id="pay_person_num">0</strong></em></li>
	                    <li><span class="graytitle"><?php echo Lang('total_pay_times'); ?>：</span><em><span id="pay_times" class="graytitle">0</span></em></li>
	                </ul>
	            </div>
	   		</div>
	   	</div>
