...
$(function() {
	...
	$('#couponlist').on('click', 'a.view', function() {
		...
		if (id > 0) {
			dialog = $.dialog({id: 'coupon_view', title: '<?php echo Lang('coupon_view_record')?>', width:960});
			$.ajax({
	...
	$('#div_pop').on('click', '.btn_thin1', function(e){
		coupon_log_setting(0);
	});
});
function coupon_log_setting(cou_id){
...
<h2><span id="tt"><?php echo Lang('coupon_log'); ?></span></h2>
<div id="bgwrap">
	<br class="clear">
	<div class="onecolumn">
		<div class="header">
		...
		<div class="tool_date">
			<div class="title cf">
				...
				<div class="tool_group">
					 ...
					 <label>
					 	<select name="sid" class="sid ipt_select" id="sid2">
							<option value="0"><?php echo Lang('all_server') ?></option>
						</select></label>
					<input type="hidden" name="dogetSubmit" value="1">
					<input type="submit" class="btn_sbm" name="getsubmit" id="get_search_submit" value="<?php echo Lang('search'); ?>" >
				</div>
				</form>
			</div>
		</div>
	...
	<div class="column cf" id="table_column">
		<div class="title">
	        <div class="more" id="tblMore">
	            <div id="div_pop">
	                <input class="btn_thin1" type="button" value="<?php echo Lang('coupon_log').Lang('add') ?>">
	            </div>
	        </div>
	        <?php echo Lang('coupon_log').Lang('list') ?>
	    </div>
		<table class="global" width="100%" cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					...
					<th><?php echo Lang('use'); ?></th>
					<th><?php echo Lang('get_content'); ?></th>
					<th><?php echo Lang('generate_num'); ?></th>
					<th><?php echo Lang('already_receive'); ?></th>
					<th><?php echo Lang('self_generated'); ?></th>
