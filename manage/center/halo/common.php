...
define('FAST_LOGIN',common::load_config('system', 'fast_login_url'));
define('DEFAULT_SID',common::load_config('system', 'default_sid'));
...
class common {
	...
	{
		$index = 'HTTP_ACCEPT';
		if ( $_SERVER[strtoupper($index)] !== null && stripos(strtolower($_SERVER[strtoupper($index)]),"json")) {
			return true;
		}
		return false;
	}	
