...
class api_admin extends api_base {
	...
	const ADMIN_API_FIND_CONTRIBUTION_BY_PLAYER_ID = 73;	//根据玩家ID获取帮贡记录
	const ADMIN_API_FIND_CONTRIBUTION_BY_FACTION_ID = 74;	//根据帮派ID获取帮贡记录
	const ADMIN_API_FIND_CONTRIBUTION_BY_TYPE = 75;	//根据帮贡类型获取帮贡记录
	const ADMIN_API_FIND_CONTRIBUTION_BY_TIME = 76;	//根据时间按获取帮贡记录
	const ADMIN_API_FIND_CONTRIBUTION_BY_PLAYER_ID_TIME = 77;	//根据玩家ID和时间按获取帮贡记录
	const ADMIN_API_FIND_CONTRIBUTION_BY_FACTION_ID_TIME = 78;	//根据帮派ID和时间按获取帮贡记录
	...
	//根据玩家ID查找帮贡记录
    public static function find_contribution_by_player_id ($player_id) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_PLAYER_ID,
            array(
                self::pack_string(self::$ADMIN_PWD),
                self::pack_int($player_id)
            ),
			...
			array(
                'faction_contribution_list' => array(
                    'player_id'  => 'int',		
					'fantion_id'  => 'int',	
                    'type_id'   => 'enum',
                    'value'       => 'int',
	...
	//根据帮派ID查找帮贡记录
    public static function find_contribution_by_faction_id ($faction_id) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_FACTION_ID,
            array(
                self::pack_string(self::$ADMIN_PWD),
                self::pack_int($faction_id)
            ),
	...
	//根据帮贡类型查找帮贡记录
    public static function find_contribution_by_type ($contype) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_TYPE,
            array(
                self::pack_string(self::$ADMIN_PWD),
                self::pack_int($contype)
            ),
	...
	//根据时间查找帮贡记录
    public static function find_contribution_by_time ($begintime,$endtime) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_TIME,
            array(
                self::pack_string(self::$ADMIN_PWD),
                self::pack_int($begintime),
				self::pack_int($endtime)
            ),
	...
	//根据玩家ID时间查找帮贡记录
    public static function find_contribution_by_player_id_time ($player_id,$begintime,$endtime) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_PLAYER_ID_TIME,
            array(
                self::pack_string(self::$ADMIN_PWD),
				self::pack_int($player_id),
                self::pack_int($begintime),
	...
	//根据帮派ID和时间查找帮贡记录
    public static function find_contribution_by_fantion_id_time ($fantion_id,$begintime,$endtime) {
        return self::invoke_api(
            self::ADMIN_API_MODULE,
            self::ADMIN_API_FIND_CONTRIBUTION_BY_FACTION_ID_TIME,
            array(
                self::pack_string(self::$ADMIN_PWD),
				self::pack_int($fantion_id),
                self::pack_int($begintime),
				self::pack_int($endtime)
            ),
...
//print_r(api_admin::find_contribution_by_type(2));
