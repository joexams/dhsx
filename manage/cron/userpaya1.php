...
<form action="userpaya1.php" method="post" name="form">
<table class="table">
   <tr>
  ...
  <tr>
    <td align="right"><strong>平台</strong></td>
	<td>
	<input name="form" id="form" type="text"  value="<?php echo $form?>" size="40" />
	</td>
  </tr>   
  <tr>
    <td align="right"><strong>渠道</strong></td>
	<td>
...
if($action == 'uuupay'){
	...
	if($sid){
		$sid_arr = implode(",",$sid);
		$query = $db->query("select name from servers where cid = '$cid' and sid in ($sid_arr)");		
