...
function  Player()
{
	...
	if($num)
	{
		...
		$list_pages=multi($num,$pageNum,$page,$adminWebType.".php?in=player&username=$username_url&player_id=$player_id&ip=$ip&order=$order&type=$type&mt=$mt&source=$source&day=$day&level=$level&vip=$vip&st=$st&level_s=$level_s&level_e=$level_e&yellow=$yellow&yellow_level=$yellow_level&cid=$cid&sid=$sid");	
	}
