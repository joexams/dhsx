...
$DATA_MAPS = array( //array(表, array(array(外部字段, 引用表, 引用表的字段)), array(需要修改结构的字段) 或 "log"是否记录表)
	...
	array('player_faction_quest', 
			array(
                array('id', 'player_faction_quest', 'id'),
				array('player_id', 'player', 'id')
			)
	),
	...
	array('player_blood_pet',
			array(
				...
				array('player_id', 'player', 'id'),
				array('player_role_id', 'player_role', 'id'),
				array('point_player_role_id', 'player_role', 'id')
			)
		),
	...
	array('player_borrow_partner',
			array(
				array('player_id', 'player', 'id'),
				array('borrow_player_role_id', 'player_role', 'id'),
				array('release_player_role_id', 'player_role', 'id')
			)
		),
	array('player_borrow_partner_record',
			array(
				array('id', 'player_borrow_partner_record', 'id'),
				array('player_id', 'player', 'id'),
				array('release_player_id', 'player', 'id')
			)
		),
	array('player_partner_invite_story_step_record',
			array(
			    array('id', 'player_partner_invite_story_step_record', 'id'),
				array('player_id', 'player', 'id'),
				array('role_id', 'player_role', 'id')
			)
		),
	array('player_partners_video_record',
			array(
				array('id', 'player_partners_video_record', 'id'),
				array('player_id', 'player', 'id')
			)
		),
	array('player_partners_invite_storys_award',
			array(
				array('id', 'player_partners_invite_storys_award', 'id'),
				array('player_id', 'player', 'id')
			)
		),
	array('player_partners_invite_completed_ending',
			array(
				array('id', 'player_partners_invite_completed_ending', 'id'),
				array('player_id', 'player', 'id'),
				array('role_id', 'player_role', 'id')
			)
		),
	array('player_daily_recharge',
			array(
				array('id', 'player_daily_recharge', 'id'),
				array('player_id', 'player', 'id')
			)
		),
	array('player_hire_role',
			array(
				array('player_id', 'player', 'id'),
				array('player_role_id', 'player_role', 'id')
			)
		),
	array('player_server_team_buying_data',
			array(
				array('id', 'player_server_team_buying_data', 'id'),
				array('player_id', 'player', 'id')
			)
		),
	array('player_dragon_boat',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_charge_rebate',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_mouth_card',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_ingot_eggs',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_temp_warehouse_item',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_marry_mission',
			array(
				array('marry_id', 'player_marry_info', 'id'),
                array('opt_player', 'player', 'id')
			)
		),
	array('player_marry_mission_grid',
			array(
				array('marry_id', 'player_marry_info', 'id')
			)
		),
	array('player_marry_mission_ground',
			array(
				array('marry_id', 'player_marry_info', 'id')
			)
		),
	array('player_marry_gold_log',
			array(
				array('id', 'player_marry_gold_log', 'id'),
				array('marry_id', 'player_marry_info', 'id')
			)
		),
	array('player_faction_business',
			array(
				array('player_id', 'player', 'id')
			)
		),
	array('player_faction_business_path',
			array(
				array('id', 'player_faction_business_path', 'id'),
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_marry_mission_npc',
			array(
				array('marry_id', 'player_marry_info', 'id')
			)
		),
        
    array('player_mounts_chip',
			array(
                array('id', 'player_mounts_chip', 'id'),
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_mounts_chip_log',
			array(
                array('id', 'player_mounts_chip_log', 'id'),
				array('player_id', 'player', 'id')
			)
		),
    ...
    array('player_all_suit',
			array(
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_suit_chip_log',
			array(
                array('id', 'player_suit_chip_log', 'id'),
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_god_partner',
			array(
				array('player_role_id', 'player_role', 'id')
			)
		),
        
    array('player_god_partner_grid',
			array(
                array('id', 'player_god_partner_grid', 'id'),
				array('player_role_id', 'player_role', 'id')
			)
		),
        
    array('player_god_partner_package',
			array(
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_god_partner_tatter',
			array(
                array('id', 'player_god_partner_tatter', 'id'),
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_god_partner_tatter_log',
			array(
                array('id', 'player_god_partner_tatter_log', 'id'),
				array('player_id', 'player', 'id')
			)
		),
    ...
    array('player_god_samite',
            array(
				array('player_id', 'player', 'id')
			)
		),
        
    array('player_achievement_award',
            array(
                array('id', 'player_achievement_award', 'id'),
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_daily_sign_in',
            array(
                array('id', 'player_daily_sign_in', 'id'),
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_daily_sign_in_data',
            array(
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_hidden_ling_yun_shop',
            array(
                array('id', 'player_hidden_ling_yun_shop', 'id'),
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_wai_gua',
            array(
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_pet_lottery',
            array(
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_sport_reward',
            array(
                array('player_id', 'player', 'id')
            )
        ),
        
    array('player_super_month_card',
            array(
                array('player_id', 'player', 'id')
            )
        ),
    ...
    array('player_doumiao_tree_data',
            array(
                array('player_id', 'player', 'id')
            )
        ),
        
	array('player_auto_multiple_mission',
            array(
                array('player_id', 'player', 'id')
            )
        ),
