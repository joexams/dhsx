    ...
    public class ProtoSpecColumn
    {
        ...
        public ProtoSpecSubset Format
        {
            get
            {
                if (ClassName != null)
                {
                    ProtoSpecModule classModule = ParentAction.ParentModule;

                    if (ClassModule != null)
                    {
                        classModule = ParentAction.ParentModule.ParentDocument.Modules.GetByName(ClassModule, true);
        ...
        public ProtoSpecColumn Colon()
        {
            ...
            result.ParentAction = this.ParentAction;
    ...
    public class ProtoSpecClassDef
    {
        ...
        public ProtoSpecSubset GetFullSpec(ProtoSpecAction action)
        {
            ...
            if (ClassBaseName != null)
            {
                ...
                {
                    resultSpec.Columns.Add(column.Colon());
                }
            }
