...
function  PassivityDataType() 
{
	...
	$columns_list = globalColumnsList('passivity_level_war_attr');//被动技能属性表字段信息
	$num = $db->result($db->query("
	select 
		count(*) 
	from 
...
//	
//	$tb_query = $db->query("
//	SHOW FULL COLUMNS FROM `passivity_level_war_attr`
//	");
//	
//	while($tb_rs = $db->fetch_array($tb_query))
//	{
//		$tb_list_array[] = $tb_rs;
//	}
